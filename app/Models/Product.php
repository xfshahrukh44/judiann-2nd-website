...
class Product extends Model implements Buyable
{
    ...
    {
        return $this->hasMany('App\Models\OptionProduct')->whereHas('option', function ($q) {
    ...
    {
        return $this->hasMany('App\Models\ProductAttribute')->with('attribute.attributeGroup')->whereHas('attribute', function ($q) {
            return $q->where('status', 1);
        });
    }
}
