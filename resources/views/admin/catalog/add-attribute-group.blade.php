...
@section('title', isset($attrGroup->id) ? 'Edit Addon Group' : 'Add Addon Group')
@section('section')
    <style>
        .switch {
            position: relative;
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Addon Group Form</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{url('admin/dashboard')}}">Home</a></li>
                            <li class="breadcrumb-item active">Addon Group Form</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">{{isset($attrGroup->id) ? 'Edit' : 'Add'}} Addon Group</h3>
                            </div>
                            ...
                            <form class="attribute-group-form" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <label for="name" class="ml-2">Addon Group Name</label>
