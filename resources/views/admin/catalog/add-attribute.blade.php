...
@section('title', isset($attribute->id) ? 'Edit Addon' : 'Add Addon')
@section('section')
    <style>
        .switch {
            position: relative;
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">{{isset($attribute->id) ? 'Edit' : 'Add'}} Addon</h3>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row col-md-12">
                                        <div class="form-group col-md-10">
                                            <label for="name">Select Addon Group</label>
                                    ...
                                    <label for="name" class="ml-2">Addon Name</label>
                                    <div class="row col-md-12">
                                        <div class="col-md-10">
