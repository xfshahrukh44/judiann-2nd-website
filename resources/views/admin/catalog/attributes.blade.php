                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a class="btn btn-primary pull-right addBtn" href="{{route('catalog.addAttributes')}}">Add Addon</a>
                            </div>
                            <div class="col-md-12">
   ...
   <script>
        $(document).ready(function () {
            ...
            $(document).on('click','#ok_delete',function(){
                $.ajax({
                    url:"{{url('admin/catalog/destroy-attribute')}}/"+delete_id,
                    type:'post',
                    data:{
                        id:delete_id,
                        "_method": 'DELETE',
