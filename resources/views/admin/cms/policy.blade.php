                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form class="category-form" method="post" action="{{route('admin.cms.policy')}}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('policy') is-invalid @enderror" name="policy"
                                                          placeholder="Privacy & Conditions"
