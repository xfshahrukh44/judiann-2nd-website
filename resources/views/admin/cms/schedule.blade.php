                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form class="category-form" method="post" action="{{route('admin.cms.schedule')}}"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="meta_title"
                                                       value="{{!empty($schedule) ? ($data->meta_title ?? '') : ''}}"
                                                       placeholder="Meta Title">
                                            </div>
                                            <div class="form-group">
                                                <label for="name">Meta Description</label>
                                                <input type="text" class="form-control" name="meta_description"
                                                       value="{{!empty($schedule) ? ($data->meta_description ?? '') : ''}}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="banner_title"
                                                       value="{{!empty($schedule) ? ($data->banner_title ?? '') : ''}}"
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="img-upload">
                                                        <div id="image-preview" class="img-preview"
                                                             style="background: url({{ !empty($schedule) ? (!empty($data->banner_image) ? asset('front/images/cms/'.$data->banner_image) : asset('front/images/BannerImg.jpg')) : asset('front/images/BannerImg.jpg') }});">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="section_title"
                                                       value="{{!empty($schedule) ? ($data->section_title ?? '') : ''}}"
                                                       placeholder="Title">
                                            </div>
