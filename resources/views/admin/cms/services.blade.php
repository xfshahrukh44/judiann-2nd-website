                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form class="category-form" method="post" action="{{route('admin.cms.services')}}"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="meta_title"
                                                       value="{{!empty($services) ? ($data->meta_title ?? '') : ''}}"
                                                       placeholder="Meta Title">
                                            </div>
                                            <div class="form-group">
                                                <label for="name">Meta Description</label>
                                                <input type="text" class="form-control" name="meta_description"
                                                       value="{{!empty($services) ? ($data->meta_description ?? '') : ''}}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="banner_title"
                                                       value="{{!empty($services) ? ($data->banner_title ?? '') : ''}}"
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="img-upload">
                                                        <div id="image-preview" class="img-preview"
                                                             style="background: url({{ !empty($services) ? (!empty($data->banner_image) ? asset('front/images/cms/'.$data->banner_image) : asset('front/images/BannerImg.jpg')) : asset('front/images/BannerImg.jpg') }});">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="service_title"
                                                       value="{{!empty($services) ? ($data->service_title ?? '') : ''}}"
                                                       placeholder="Title">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="service_content"
                                                          placeholder="Content"
                                                          rows="4">{{!empty($services) ? ($data->service_content ?? '') : ''}}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="offer_title"
                                                       value="{{!empty($services) ? ($data->offer_title ?? '') : ''}}"
                                                       placeholder="Title">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="offer_content1"
                                                          placeholder="Content"
                                                          rows="4">{{!empty($services) ? ($data->offer_content1 ?? '') : ''}}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="name">Content # 2</label>
                                                <textarea class="form-control" name="offer_content2"
                                                          placeholder="Content"
                                                          rows="4">{{!empty($services) ? ($data->offer_content2 ?? '') : ''}}</textarea>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="float-right">
                                            <a href="{{route('admin.service.index')}}" class="btn btn-primary mb-4">ADD
                                                Services</a>
                                        </div>
                                        <table class="table">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form action="{{route('admin.service.destroy', $service->id)}}"
                                                              class="form-group d-inline-flex" method="POST">
                                                            @csrf
                                                            @method('delete')
