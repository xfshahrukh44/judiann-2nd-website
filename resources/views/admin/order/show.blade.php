                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <table class="table table-bordered">
                                        <thead>
                                        <tr>
                                            <td style="width: 50%;font-weight: bold" class="text-left">Billing details
                                            </td>
...
{{--                                            </td>--}}
                                        ...
                                        <tr>
                                            <td class="text-left">
                                                ...
                                                <br>
                                                <strong>Time to Pickup</strong> : {{$order->time_to_pickup}}
                                                <br>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @forelse($order->orderItems as $orderItems)
                                            <tr>
                                                ...
                                                <td class="right">${{round($orderItems->product_per_price, 2)}}</td>
                                    ...
                                    <div class="col-lg-4 col-sm-5 ml-auto">
                                        <table class="table table-clear">
                                            ...
                                            <tr>
                                                ...
                                                <td class="right">${{round($order->sub_total, 2)}}</td>
                                            </tr>
                                            @if($order->discount > 0)
                                                <tr>
                                                    <td class="left">
                                                    ...
                                                    <td class="right">${{round($order->discount, 2)}}</td>
                                                </tr>
                                            @endif
                                            @if((float)$order->tax > 0)
                                                <tr>
                                                    ...
                                                    <td class="right">${{round($order->tax, 2)}}</td>
                                                </tr>
                                            @endif
                                            @if((float)$order->shipping_cost > 0)
                                                <tr>
                                                    ...
                                                    <td class="right">${{round($order->shipping_cost, 2)}}</td>
                                                </tr>
                                            @endif
                                            ...
                                            <tr>
                                                ...
                                                <td class="right">
                                                    <strong>${{round($order->total_amount, 2)}}</strong>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
