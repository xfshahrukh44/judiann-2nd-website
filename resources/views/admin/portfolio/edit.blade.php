                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form class="category-form" method="post" action="{{route('admin.portfolio.update', $portfolio->id)}}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="img-upload">
                                                    <div id="image-preview" class="img-preview"
                                                         style="background: url({{$portfolio->get_portfolio_image()}});">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="name">Image Order</label>
                                                <input type="number" name="image_order" class="form-control"
                                                       placeholder="Order of Image" value="{{$portfolio->image_order}}">
                                            </div>
