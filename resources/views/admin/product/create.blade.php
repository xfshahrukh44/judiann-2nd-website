                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#attributes" role="tab" data-toggle="tab">Product Addons</a>
                                        </li>
                                        {{--                                        <li class="nav-item">--}}
...
{{--                                                    <th>Qty</th>--}}
                                                ...
                                                <tr>
                                                    <td>
                                                        <select id="option_id" class="form-control" name="option_id[]"
                                                                onchange="getOptionValues(1,this.value)">
                                                    ...
                                                    <td>
                                                        <select id="option_value_id_1" class="form-control"
                                                                name="option_value_id[]"></select>
                                                    </td>
                                                    <td><input type="number" class="form-control" value=""
                                                               name="option_value_price[]" step="0.01"></td>
                                                    <td hidden><input type="number" class="form-control" value="0"
                                        ...
                                        <div class="tab-pane" role="tabpanel" class="tab-pane fade in active"
                                            ...
                                            <div class="col-md-12 text-right">
                                                <input type="button" class="btn btn-primary btn-sm"
                                                       value="Add Product Addon" onclick="addMoreAttributes()"
                                                       style="margin-top: 10px;margin-bottom: 10px;">
                                            </div>
                                            <table class="table table-bordered">
                                                <thead>
                                                            ...
                                                            @foreach($attributeGroups as $attributeGroup)
                                                                <optgroup label="{{$attributeGroup->attribute_group}}">
                                                                    @foreach($attributeGroup->attributes as $attributes)
                                                                        <option
                                                                            value="{{$attributes->id}}">{{$attributes->attribute_name}}</option>
                                                                    @endforeach
                                                                </optgroup>
                                                            @endforeach
                                                        </select>
        ...
        function addMoreOptions() {
            ...
            <td>
                <select id="option_value_id_${counterO}" class="form-control" name="option_value_id[]"></select>
                                            ...
                                            <td><input type="number" class="form-control" value="" name="option_value_price[]" step="0.01"></td>
