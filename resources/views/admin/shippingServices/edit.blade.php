                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form class="category-form" method="post"  action="{{route('shippingServices')}}" enctype="multipart/form-data">
                                @csrf
                             <div class="card-body">
                                <div class="row">
                                   <div class="col-md-12">
                                              ...
                                              <div id="collapseOne" class="collapse border border-dark" aria-labelledby="headingOne" data-parent="#accordion">
                                                <div class="card-body">
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-md-9">
                                                             <input type="radio" name="usps[env]" required id="usps_env_live" @if(isset($content['USPS']['env']) && $content['USPS']['env'] == 'live') checked @endif value="live"> Live &nbsp;
                                                            <input type="radio" name="usps[env]" required id="usps_env_testing" @if(isset($content['USPS']['env']) && $content['USPS']['env'] == 'testing') checked @endif  value="testing"> Testing
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="usps[user_id]" id="usps_username" required class="form-control" value="{{$content['USPS']['user_id'] ?? ''}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="usps[password]" id="usps_password" required  class="form-control" value="{{$content['USPS']['password']??''}}" >
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="usps[access_key]" id="usps_key" required  class="form-control" value="{{$content['USPS']['access_key']??''}}" >
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="usps[shipper_number]" id="usps_shipper_number" required  class="form-control" value="{{$content['USPS']['shipper_number']??''}}" >
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-9">
                                                            <label class="switch">
                                                                <input type="checkbox" name="usps[status]" @if(isset($content['USPS']['status']) && $content['USPS']['status'] == '1') checked @endif value="1"  data-id="" id="usps_switch">
