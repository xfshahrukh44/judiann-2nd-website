...
@section('content')
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="slideContent">
                            <h2 class="headOne">{{!empty($student_work) ? (!empty($data->banner_title) ? $data->banner_title : 'Julie Moon') : 'Julie Moon'}}</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="wrkSec">
        <div class="container-fluid">
            {{--            <div class="row">--}}
            <h2 class="headOne">{{!empty($student_work) ? (!empty($data->section_title) ? $data->section_title : 'Julie Moon') : 'Julie Moon'}}</h2>
            <div class="row">
                <div class="col-md-4">
                    <a data-fancybox
