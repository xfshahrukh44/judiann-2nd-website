    ...
    <section class="srvcSec serviceInner">
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <figure><img src="images/service1.jpg" class="w-100" alt=""></figure>
                </div>
                <div class="col-md-6">
            ...
            <div class="row align-items-center my-5">
                <div class="col-md-6">
                    <figure><img src="images/service2.jpg" class="w-100" alt=""></figure>
                </div>
                <div class="col-md-6">
            ...
            <div class="row align-items-center my-5">
                <div class="col-md-6">
                    <figure><img src="images/service3.jpg" class="w-100" alt=""></figure>
                </div>
                <div class="col-md-6">
            ...
            <div class="row align-items-center my-5">
                <div class="col-md-6">
                    <figure><img src="images/service4.jpg" class="w-100" alt=""></figure>
                </div>
                <div class="col-md-6">
            ...
            <div class="row align-items-center my-5">
                <div class="col-md-6">
                    <figure><img src="images/service5.jpg" class="w-100" alt=""></figure>
                </div>
                <div class="col-md-6">
